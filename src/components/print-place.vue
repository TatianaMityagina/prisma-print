			...
			<div class="print-place__items">
				<div class="print-place__item" @click="anchor('Home')">
					...
					<div class="print-place__item-text">
						<h3>ДОМОЙ</h3>
						<p>
							Свадебные фотографии, завораживающие пейзажи, 
							двойные экспозиции, абстракции Кандинского В.В. 
							и просто котики! Вы готовы слышать: “Ах! Как атмосферно!”?
						</p>
					</div>
				</div>
				...
				<div class="print-place__item print-place__item--second" @click="anchor('Office')">
					...
					<div class="print-place__item-text print-place__item-text--second">
						<h3>КОММЕРЦИЯ</h3>
						<p>
							Меняйте корпоративную обстановку чаще. 
							Доказано - это повышает продуктивность рабочих будней. 
							С нами измениться легко - это не ремонт. 
						</p>
					</div>
				</div>
			</div>     
...
<style scoped lang="scss">
  ...
  @media (max-width: 1599px) {
		...
		.print-place__item-text--second p {
			text-align: start;
		}
  }
